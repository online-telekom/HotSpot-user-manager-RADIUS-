...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Trenutno nema podataka za prikaz"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Učitavanje..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
b[c]:""!==c?Q(c)(b):b}function pb(a){var b=a.oClasses,c=a.sTableId,d=a.oLanguage,e=a.oPreviousSearch,f=a.aanFeatures,g='<i class="material-icons" style="position: absolute;margin-top: 10px;margin-left: -15px;">search</i><input type="search" class="'+b.sFilterInput+'"/>',j=d.sSearch,j=j.match(/_INPUT_/)?j.replace("_INPUT_",g):j+g,b=h("<div/>",{id:!f.f?c+"_filter":null,"class":b.sFilter}).append(h("<label/>").append(j)),f=function(){var b=!this.value?"":this.value;b!=e.sSearch&&(ha(a,{sSearch:b,bRegex:e.bRegex,bSmart:e.bSmart,bCaseInsensitive:e.bCaseInsensitive}),a._iDisplayStart=0,O(a))},g=null!==
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"Trenutno nema podataka za prikazati.",sInfo:"Prikaz: _START_ - _END_ od _TOTAL_ ukupno.",sInfoEmpty:"Trenutno nema prikaza.",sInfoFiltered:"(Pretraženo _MAX_ podatka.)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Prikaži podataka _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Pretraga:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Vaša pretraga je neuspiješna"},oSearch:h.extend({},
